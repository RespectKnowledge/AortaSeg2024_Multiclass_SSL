...
parser.add_argument("--roi_x", default=176, type=int, help="roi size in x direction")
...
model_training_output_dir = '/home/aqayyum/SSL_xLSTM_model/Aorta/dataset/'
...
pathdata='/home/aqayyum/SSL_xLSTM_model/Aorta/main_data/'
pathimg = glob(os.path.join(pathdata, '*.nii.gz'))
...
best_loss = float('inf')
save_path = 'best_student_model_enco_bottom_aorta1.pth'
